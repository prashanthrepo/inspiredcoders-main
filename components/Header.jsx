            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              <li>
                <Link href="/signin">
                  ...
                  px-4 py-3 flex items-center transition duration-150
                  ease-in-out">
                    {' '}
                    Sign in
                  </a>
              ...
              <ul className="bg-gray-800 px-4 py-2">
                  ...
                  <ul className="pl-4">
                    <li>
                      <Link href="/contact">
                        <a
                          href=""
                          className="text-sm flex font-medium text-gray-400
                        hover:text-gray-200 py-2">
                          {' '}
                          Contact us
                        </a>
                      </Link>
                ...
                <li>
                  <Link href="/signin">
                    <a
                      href=""
                      className="flex font-medium w-full text-purple-600
                    hover:text-gray-200 py-2 justify-center">
                      {' '}
                      Sign in
                    </a>
                  </Link>
                ...
                <li>
                  <Link href="/signup">
                    <a
                      href=""
                      className="font-medium w-full inline-flex items-center
                    justify-center border border-transparent px-4 py-2 my-2
                    rounded-sm text-white bg-purple-600 hover:bg-purple-700
